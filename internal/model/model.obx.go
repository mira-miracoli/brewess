...
func (malt_EntityInfo) AddToModel(model *objectbox.Model) {
	model.Entity("Malt", 1, 3654763371068763047)
	model.Property("Id", 6, 1, 1878438778592493007)
	model.PropertyFlags(1)
	model.Property("Name", 9, 2, 6524314142546606709)
	model.Property("Amount", 6, 3, 4869481280457807193)
	model.Property("EBC", 6, 4, 2397768903838672725)
	model.EntityLastPropertyId(4, 2397768903838672725)
}
...
func (hop_EntityInfo) AddToModel(model *objectbox.Model) {
	model.Entity("Hop", 2, 3109559498632667078)
	model.Property("Id", 6, 1, 1859828174212255080)
	model.PropertyFlags(1)
	model.Property("Name", 9, 2, 1524669187906431133)
	model.Property("Amount", 6, 3, 6370563162644528664)
	model.Property("Iso", 7, 4, 5549877410473105187)
	model.EntityLastPropertyId(4, 5549877410473105187)
}
...
func (yeast_EntityInfo) AddToModel(model *objectbox.Model) {
	model.Entity("Yeast", 3, 4183773918897404406)
	model.Property("Id", 6, 1, 5422436074238775266)
	model.PropertyFlags(1)
	model.Property("Name", 9, 2, 7956210914367276321)
	model.Property("Amount", 6, 3, 1641309061918568156)
	model.Property("MinTemp", 7, 4, 5881370876310109916)
	model.Property("MaxTemp", 7, 5, 7947361413816752847)
	model.Property("OberG", 1, 6, 8494613577001114068)
	model.EntityLastPropertyId(6, 8494613577001114068)
}
...
func (recipe_EntityInfo) AddToModel(model *objectbox.Model) {
	model.Entity("Recipe", 4, 4227538287323955228)
	model.Property("Id", 6, 1, 4280144815472854206)
	model.PropertyFlags(1)
	model.Property("Name", 9, 2, 1937909533683679463)
	model.Property("Description", 9, 3, 2872287476873077822)
	model.Property("IsoAlpha", 7, 4, 7671264917189568994)
	model.Property("HopSugg", 30, 5, 7395310028887276513)
	model.Property("DryHop", 30, 6, 835608935226063632)
	model.Property("SHA", 7, 7, 5040363575523988274)
	model.Property("AlcTarget", 7, 8, 1805142047403128018)
	model.Property("OGTarget", 7, 9, 8229586996746706543)
	model.EntityLastPropertyId(9, 8229586996746706543)
	model.Relation(1, 1082614423144253547, MaltBinding.Id, MaltBinding.Uid)
	model.Relation(2, 7258612969345776557, HopBinding.Id, HopBinding.Uid)
	model.Relation(3, 2771706771742051071, YeastBinding.Id, YeastBinding.Uid)
}
